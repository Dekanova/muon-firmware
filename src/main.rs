...
#[rtic::app(device = crate::hal::pac, peripherals = true, dispatchers = [PIO0_IRQ_0])] // extra PIO0_IRQ_1, PIO1_IRQ_0
mod app {
    use crate::hal;
    ...
    fn init(ctx: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        let monotonic = rp2040_monotonic::Rp2040Monotonic::new(ctx.device.TIMER);
